...
/usr/bin/rsync --exclude "archive" --exclude "*ALLDATA.csv" --exclude "*RESET.csv" -rv /mnt/space/workspace/instrument_processing/data/ /var/lib/tomcat9/webapps/ROOT/data/
/usr/bin/rsync -rv /mnt/space/workspace/instrument_processing/data/site/5000/ALLDATA /var/lib/tomcat9/webapps/ROOT/data/site/5000/
/usr/bin/rsync -rv /mnt/space/workspace/instrument_processing/data/site/5200/ALLDATA /var/lib/tomcat9/webapps/ROOT/data/site/5200/
/usr/bin/rsync -rv /mnt/space/workspace/instrument_processing/data/site/5100/ALLDATA /var/lib/tomcat9/webapps/ROOT/data/site/5100/
