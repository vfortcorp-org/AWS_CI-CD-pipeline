...
var lyr_railroad_2 = new ol.layer.Tile({
                            source: new ol.source.TileWMS(({
                              url: "https://www.augustarain.com/geoserver/aed/wms",
    attributions: ' ',
                              params: {
                                "LAYERS": "railroad",
                                "TILED": "true",
...
maxResolution:3.3605359382714357,
              ...
              wms_layers.push([lyr_AED_Ponds_8, 0]);
...
maxResolution:3.3605359382714357,
              ...
              wms_layers.push([lyr_AED_Pipes_9, 0]);
...
maxResolution:3.3605359382714357,
              ...
              wms_layers.push([lyr_AED_Ditches_10, 0]);
...
maxResolution:3.3605359382714357,
              ...
              wms_layers.push([lyr_AED_Structures_11, 0]);
